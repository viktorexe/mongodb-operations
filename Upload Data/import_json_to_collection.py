...
def import_json_to_collection(db_name, collection_name, input_file):
...
if __name__ == "__main__":
    ...
    input_file = input("Input JSON file: ").strip()
    import_json_to_collection(db_name, collection_name, input_file)
